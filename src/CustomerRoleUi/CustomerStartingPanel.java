...
public class CustomerStartingPanel extends javax.swing.JPanel {
    ...
    public CustomerStartingPanel(SystemAdmin systemAdmin, Runnable callOnCreateMethod1, Runnable callOnCreateMethod2) {
        initComponents();
