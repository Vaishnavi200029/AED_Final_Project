...
public class BusinessEvent extends Services {
    ...
    public List<DecorationServices> getListOfDecors() {
        return listOfDecors;
    }

    public void setListOfDecors(List<DecorationServices> listOfDecors) {
    ...
    public void addDecorService(String name, String contact, String city) {
        DecorationServices decor = new DecorationServices(name, contact, city);
    ...
    public void deleteDecor(DecorationServices decor) {
